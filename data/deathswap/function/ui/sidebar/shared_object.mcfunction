...
#header
$execute if score *language deathswap.setting matches 1 run scoreboard objectives modify $(score_objectives) displayname {text:"Death Swap",color:gold}
$execute if score *language deathswap.setting matches 2 run scoreboard objectives modify $(score_objectives) displayname {text:"死亡交換",color:gold}
